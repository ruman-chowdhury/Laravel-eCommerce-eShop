        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li><a href="{{ route('admin.category.add.form') }}"><i class="icon-envelope"></i><span class="hidden-tablet"> Add Category</span></a></li>
                    <li><a href="{{ route('admin.category.read') }}"><i class="icon-tasks"></i><span class="hidden-tablet"> All Categories</span></a></li>
